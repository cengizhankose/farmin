...
export default function OpportunitiesPage() {
  ...
  return (
    <>
      <Head>
        <title>Yield Opportunities | Farmin</title>
        ...
        <meta property="og:title" content="Yield Opportunities | Farmin" />
        ...
        <meta name="twitter:title" content="Yield Opportunities | Farmin" />
