...
//     projections.find((p) => p.timeframe === timeframe) || projections[0];
...
//           Based on {selectedProjection.simulationCount.toLocaleString()}{" "}
//           simulations
//         </div>
//       </div>
...
//               (
//               {formatPercentage(
//                 ((selectedProjection.expectedValue - currentTvl) / currentTvl) *
//                   100,
//               )}
//               )
//             </div>
...
//         <div className="text-xs text-white/50">
//           Confidence Interval:{" "}
//           {formatCurrency(selectedProjection.confidenceInterval[0])} -{" "}
//           {formatCurrency(selectedProjection.confidenceInterval[1])}
//         </div>
//       </div>
...
//           {Object.entries(selectedProjection.scenarios).map(
//             ([scenario, data]) => (
//               <motion.div
//                 key={scenario}
...
//                 <div className="flex items-center justify-between mb-2">
//                   <span
//                     className={`text-sm font-medium capitalize ${getScenarioColor(scenario)}`}
//                   >
//                     {scenario}
//                   </span>
...
//                   Range: {formatCurrency(data.range[0])} -{" "}
//                   {formatCurrency(data.range[1])}
//                 </div>
