  ...
  const riskComponents = [
    {
      ...
      description:
        "Risk related to the ability to exit positions without significant price impact",
      factors: [
      ...
      <div className="mb-6 p-4 bg-white/5 rounded-lg border border-white/10">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-2">
            <span
              className={`text-2xl font-bold ${getRiskColor(riskScore.total)}`}
            >
        ...
        {riskComponents.map((component) => (
          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-2">
                <span
                  className={`text-lg font-bold ${getRiskColor(component.score)}`}
                >
