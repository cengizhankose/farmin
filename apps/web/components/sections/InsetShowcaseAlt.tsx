...
export default function InsetShowcaseAlt({
  ...
  const twoBlocks: Block[] = blocks?.length
    ? blocks.slice(0, 2)
    : [
        {
          title: "Router (A)",
          body: "Smartly splits deposits across venues with min-out protection and per-tx caps.",
        },
        {
          title: "Risk Engine",
          body: "Real-time health checks, APY normalization, and transparent risk scoring.",
        },
      ];
        ...
        <div className="relative grid grid-cols-12 gap-y-10 lg:gap-y-0 lg:gap-x-10 py-14 md:py-20">
          <div className="col-span-12 lg:col-span-6 py-0 px-6 md:px-10">
            ...
            {title && (
              <h2
                className={[
                  "mt-3 font-semibold text-white tracking-tight text-5xl md:text-6xl",
